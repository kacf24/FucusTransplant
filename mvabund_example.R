...
mod3 <- manyglm(Herb_spp ~s_tASVs2$transect+s_tASVs2$day+s_tASVs2$treatment+s_tASVs2$day:s_tASVs2$treatment)
...
x<-anova(mod3,pairwise.comp=s_tASVs2$interaction,show.time = "all")
